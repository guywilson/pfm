...
class DBRecurringChargeView : public DBRecurringCharge {
    ...
    public:
        ...
        DBResult<DBRecurringChargeView> getChargesOutstandingThisPeriod(pfm_id_t & accountId);
        DBResult<DBRecurringChargeView> getChargesPaidThisPeriod(pfm_id_t & accountId);
